...
exports.quizSampleData = void 0;
exports.quizSampleData = [
    {
        quizTitle: 'Laravel beginner level quiz',
        quizDescription: 'In this quiz, you are going to be asked some basic questions which will target your knowledge of Laravel',
        questions: [
            {
    ...
    },
    {
        ...
        quizDescription: 'In this quiz, you are going to be asked some basic questions which will target your knowledge of React Js',
        questions: [
            {
                question: 'How to put Laravel applications in maintenance mode?',
                options: [
